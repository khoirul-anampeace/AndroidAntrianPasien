...
public class PoliklinikLamaAdapter extends RecyclerView.Adapter<PoliklinikLamaAdapter.ViewHolder> {
    private List<String> poliklinikList;
    private ItemClickListener itemClickListener;

    public PoliklinikLamaAdapter(List<String> poliklinikList, ItemClickListener itemClickListener) {
